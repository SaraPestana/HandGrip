...
from novainstrumentation.novainstrumentation.code import smooth
from IWANTTOFINDNOISE.FeaturesANDClustering.MF import MF_calculus, PowerSpectrum
from IWANTTOFINDNOISE.FeaturesANDClustering.PeakFinder import detect_peaks
